...
@"_SM7__constG1-1" = private unnamed_addr constant { ptr, i32, i32, [40 x i16] } { ptr @"_SM35scala.scalanative.runtime.CharArrayG4type", i32 40, i32 2, [40 x i16] [ i16 115, i16 99, i16 97, i16 108, i16 97, i16 46, i16 115, i16 99, i16 97, i16 108, i16 97, i16 110, i16 97, i16 116, i16 105, i16 118, i16 101, i16 46, i16 114, i16 117, i16 110, i16 116, i16 105, i16 109, i16 101, i16 46, i16 106, i16 97, i16 118, i16 97, i16 108, i16 105, i16 98, i16 46, i16 80, i16 114, i16 111, i16 120, i16 121, i16 36 ] }
@"_SM7__constG1-2" = private unnamed_addr constant { ptr, ptr, i32, i32, i32 } { ptr @"_SM16java.lang.StringG4type", ptr @"_SM7__constG1-1", i32 0, i32 40, i32 -711274128 }
...
@"_SM40scala.scalanative.runtime.javalib.Proxy$G4type" = hidden global { { ptr, i32, i32, ptr, ptr }, i32, i32, ptr, i32, ptr, ptr, [3 x ptr] } { { ptr, i32, i32, ptr, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 951, i32 0, ptr @"_SM7__constG1-0", ptr @"_SM7__constG1-2" }, i32 8, i32 951, ptr @"_SM7__constG1-3", i32 0, ptr @"_SM7__constG1-4", ptr @"_SM16java.lang.ObjectG4type", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
...
define void @"_SM40scala.scalanative.runtime.javalib.Proxy$D37GC_setWeakReferencesCollectedCallbackL34scala.scalanative.unsafe.CFuncPtr0uEO"(ptr %_1, ptr %_2) personality ptr @scalanative_personality {
_3000000.0:
...
define void @"_SM40scala.scalanative.runtime.javalib.Proxy$RE"(ptr %_1) personality ptr @scalanative_personality {
_2000000.0:
  ret void
}