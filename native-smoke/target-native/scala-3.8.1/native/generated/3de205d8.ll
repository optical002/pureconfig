...
@"_SM7__constG1-1" = private unnamed_addr constant { ptr, i32, i32, [34 x i16] } { ptr @"_SM35scala.scalanative.runtime.CharArrayG4type", i32 34, i32 2, [34 x i16] [ i16 115, i16 99, i16 97, i16 108, i16 97, i16 46, i16 114, i16 117, i16 110, i16 116, i16 105, i16 109, i16 101, i16 46, i16 102, i16 117, i16 110, i16 99, i16 116, i16 105, i16 111, i16 110, i16 46, i16 74, i16 80, i16 114, i16 111, i16 99, i16 101, i16 100, i16 117, i16 114, i16 101, i16 49 ] }
@"_SM7__constG1-2" = private unnamed_addr constant { ptr, ptr, i32, i32, i32 } { ptr @"_SM16java.lang.StringG4type", ptr @"_SM7__constG1-1", i32 0, i32 34, i32 232275600 }
...
@"_SM7__constG1-5" = private unnamed_addr constant { ptr, ptr, i32, i32, i32 } { ptr @"_SM16java.lang.StringG4type", ptr @"_SM7__constG1-4", i32 0, i32 34, i32 232275601 }
...
@"_SM34scala.runtime.function.JProcedure1G4type" = hidden global { ptr, i32, i32, ptr, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -2147480224, i32 2, ptr @"_SM7__constG1-0", ptr @"_SM7__constG1-2" }
@"_SM34scala.runtime.function.JProcedure2G4type" = hidden global { ptr, i32, i32, ptr, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -2147482880, i32 2, ptr @"_SM7__constG1-3", ptr @"_SM7__constG1-5" }

define dereferenceable_or_null(8) ptr @"_SM34scala.runtime.function.JProcedure1D5applyL16java.lang.ObjectL16java.lang.ObjectEO"(ptr %_1, ptr %_2) personality ptr @scalanative_personality {
_3000000.0:
...
_3000004.0:
  ...
  %_3000012 = and i32 -2147480224, %_3000009
